...
:doit
if /i "%1#" == "--libs#"    echo -L/home/join/Desktop/vlc3.0/vlc/contrib/i686-w64-mingw32/lib -llibtag
if /i "%1#" == "--cflags#"  echo -I/home/join/Desktop/vlc3.0/vlc/contrib/i686-w64-mingw32/include/taglib
if /i "%1#" == "--version#" echo 1.11
if /i "%1#" == "--prefix#"  echo /home/join/Desktop/vlc3.0/vlc/contrib/i686-w64-mingw32
