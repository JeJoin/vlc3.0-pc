...
VLC_API void input_item_SetEncryptSecret( input_item_t *p_i, const char * psz_secret ) VLC_USED;
VLC_API char * input_item_GetEncryptSecret( input_item_t *p_i ) VLC_USED;
